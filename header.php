			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php">Career Path Prediction</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="http://localhost/icgsss/blog.php">Knowledge Network</a>
								
                            </div>
                        </li>
						<!-- <li><a href="main.php#about">About Us</a></li> -->
						<li><a href="C:\xampp\htdocs\icgsss\contact.php">Contact Us</a></li>
						<li>
							<a href="C:\xampp\htdocs\icgsss\login.php">Login</a>
						</li>
						<li>
							<a href="C:\xampp\htdocs\icgsss\register.php">Register</a>
						</li>
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="C:\xampp\htdocs\icgsss\blog.php">Knowledge Network</a>
								
                            </div>
                        </li>
						<!-- <li><a href="main.php#about">About Us</a></li> -->
						<li><a href="C:\xampp\htdocs\icgsss\contact.php">Contact Us</a></li>
						<li><a href="C:\xampp\htdocs\icgsss\logout.php" >Log out</a></li>
