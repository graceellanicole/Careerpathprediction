				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">Career Path Prediction</h1>
							
							<?php
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Take a leap of faith <br>To Discover who you are meant to be.</b></p>

									<a class="main-button icon-button" href="login.php">Get Started!</a>

								<?php else: ?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Hi, <?php echo htmlspecialchars($_SESSION["username"]); ?> !<br><b>Discover yourself,<br>Discover who you are meant to be.</b></p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Career Path Prediction</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Career Path</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<a href="login.php"><h4>Career Path Prediction</h4></a>
								<?php else: ?>
					...
					<div class="col-md-4">
						...
						<i class="feature-icon fa "><span>&#x1F50E;&#xFE0E;</span></i>
							<div class="feature-content">
								<a href="C:\xampp\htdocs\icgsss\blog.php" >
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About Career Path Prediction</h2>
							<p class="lead" style="font-size: 18px; font-style: italic; margin-top: 50px;">Currently individuals (students) are experiencing wrong career path problem as most of them choose career paths depending either on parental influence, friends or even trends. This results into different outcomes such as inefficient performing individuals, dissatisfaction in work areas and sometimes even unemployment due to being inexperienced or uninterested.</p>
